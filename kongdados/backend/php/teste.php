...
<head>
    ...
    <title>Produto - Samsung Galaxy Z Fold5 (1TB)</title>
...
<body style="background-color: #efefef;">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top">
      <div class="container-fluid">
        ...
        <a href="index-site.html"><img src="logo-kong-tech.png" alt="Logo" class="img-fluid m-2" style="max-height: 35px"></a>
  ...
  <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          ...
          <form class="navbar-search" role="Pesquisar">
           ...
           <div class="navbar-icons">
              ...
              <a href="loginecadastro2.html" class="nav-link" title="Login">
    ...
    <div style="margin-left: 550px; " class="form-container">
    <img src="logo-kong-tech.png" style="width: 125px;">
        <h2 style="color: #348bea;">KONG-CADASTRO</h2>
        <form action="loginecadastro2.php" method="post">
